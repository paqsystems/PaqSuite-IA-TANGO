...
4) ~~Generar la HU docs/03-historias-usuario/000-Generalidades/HU-007-Parametros-generales.md con la historia para desarrollar el proceso general de tratamiento de esta tabla (las HU del punto 2 sólo debe invocar a este proceso, aclarando el nombre clave y el de todas las claves a utilizar - aclarando su respectivo tipo de dato)~~ ✅ `docs/03-historias-usuario/000-Generalidades/HU-007-Parametros-generales.md`
